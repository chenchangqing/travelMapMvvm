...
class SSASideMenu: UIViewController, UIGestureRecognizerDelegate {
    ...
    @IBInspectable var contentViewScaleValue: Float = 0.85
    ...
    @IBInspectable var panDirection: SSASideMenuPanDirection = .EveryWhere
    ...
    override func viewDidLoad() {
        ...
        // 动画
        let animated = CATransition()
        animated.duration = 2.0
        animated.delegate = nil
        animated.timingFunction = CAMediaTimingFunction(name:kCAMediaTimingFunctionDefault)
        animated.type = kCATransitionReveal
