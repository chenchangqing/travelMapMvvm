...
class RatingBar: UIView {
    ...
    @IBInspectable var imageLight: UIImage = UIImage(named: "ic_ratingbar_star_light.png")!
    @IBInspectable var imageDark: UIImage = UIImage(named: "ic_ratingbar_star_dark.png")!
