...
- (void)viewDidLoad {
    ...
    iv.image = [UIImage imageNamed:@"nbg"];
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"back_btn"] style:UIBarButtonItemStyleBordered target:self action:@selector(clickLeftButton)];
    self.navigationItem.title = NSLocalizedString(@"countrychoose", nil);
