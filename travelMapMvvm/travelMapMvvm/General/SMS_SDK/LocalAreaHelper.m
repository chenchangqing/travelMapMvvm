...
@implementation LocalAreaHelper

+(NSDictionary *)queryAreaCode {
    ...
    return [NSDictionary dictionaryWithObjectsAndKeys:defaultCode, @"defaultCode", defaultCountryName, @"defaultCountryName", nil];
}
